            ...
            <form action="/admin.php" method="get">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control" name="type">
                        ...
                        <option value="1" <?php if($type == 1): ?>selected="selected"<?php endif; ?>>成品</option>
                        <option value="0" <?php if($type == 0): ?>selected="selected"<?php endif; ?>>半成品</option>
                        <option value="0" <?php if($type == 2): ?>selected="selected"<?php endif; ?>>配件</option>
                    <lect>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <tbody>
                        <?php if(is_array($collect_list)): $i = 0; $__LIST__ = $collect_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$collect): $mod = ($i % 2 );++$i;?><tr>
                                <!-- <td><input size="4" type="text" name="listorder[<?php echo ($menu["menu_id"]); ?>]" value="<?php echo ($menu["listorder"]); ?>"/></td> -->
                                <td><?php echo ($collect["id"]); ?></td>
                                <td><?php echo ($collect["idnumber"]); ?></td>
